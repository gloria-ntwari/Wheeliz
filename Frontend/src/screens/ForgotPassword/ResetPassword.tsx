...
export const ResetPassword = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // Reusing the set-password endpoint since the logic (verify token, set hash) is identical
            ...
            <div className="w-full max-w-xl px-6 py-8 sm:px-8 sm:py-10 lg:px-14 lg:py-16">
              ...
              {success ? (
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 [font-family:'Barlow',Helvetica]">Password Reset!</h2>
                  <p className="text-gray-500 [font-family:'Barlow',Helvetica]">Your password has been changed successfully. Redirecting you to login...</p>
                </div>
              ) : (
                <>
                  <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="text-base text-black/70 [font-family:'Barlow',Helvetica] font-medium sm:text-lg lg:text-[16px]">
                      Enter a new secure password for your Wheeliz account.
                    </p>
                  </div>
